...
*/
char *ques_word[20] = {"Can","What","How","Where","Who","Do","Did","When","Is","Are","Which","Was","Were","Which","Was",
			"Were","Will","Shold","May"};
...
char *degree_set[10] = {"B.E.""B.Tech","M.Tech","M.E.","M.S.","B.com","MBA","B.A.","M.A.","PhD","B.Arch",};
...
*
*/
char *adj[55] = {"beutiful","clean","fency","glamorous","handsome","alive","better","carefull","clever","obedient","silly","thankfull","rich",
		"shy","zealous","proud","gentle","helpless","itchy","nervous","worried","broad","flat","high","low","narrow","skinny","big",
		"flat","short","small","tiny","tall","loud","melodic","noisy","quit","whispering","slow","fast","late","bitter","fresh",
